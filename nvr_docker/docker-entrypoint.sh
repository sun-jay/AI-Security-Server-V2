...
# ffmpeg -rtsp_transport tcp -y -stimeout 1000000 -i "rtsp://admin:admin@192.168.0.29:554?tcp" -c copy -f ssegment -segment_time 10 -reset_timestamps 1 -segment_atclocktime 1 -strftime 1 "output.mp4" -loglevel panic


# docker run -v "/Users/sunnyjay/Documents/vscode/AI Security Server V2":"/usr/data/recordings" -e VIDEO_SEGMENT_TIME=10 "hpaolini/tiny-nvr" "rtsp://admin:admin@192.168.0.29:554?tcp" my_camera

# docker run -v "/Users/sunnyjay/Documents/vscode/AI Security Server V2":"/usr/data/recordings" -e VIDEO_SEGMENT_TIME=10 "mynvr" "rtsp://admin:admin@192.168.0.29:554?tcp" my_camera
# docker run -v "/Volumes/SunnySD/Security Streams":"/usr/data/recordings" -e VIDEO_SEGMENT_TIME=10 "mynvr" "rtsp://admin:admin@192.168.0.29:554?tcp" my_camera
